...
AI 기반 학습/프로젝트 진행 시 반복되는 정리·기록·분석 작업을 AI가 직접 수행하게 하고자, MCP 프로토콜을 활용하여 설계부터 코드 분석, 문서화까지 지원하는 자동화 서버를 구축했습니다.
...
#### ✔ 커밋 후 자동으로 Notion에 정리된 코드 분석 결과

![분석 결과](images/main-demo.png)

*AI가 코드 변경을 감지해 분석 및 요약 후, 자동으로 문서화합니다.*
...
### **중기 계획**
- [ ] PARA 노트법 적용 예정(Projects-Areas-Resources-Archive 구조)
...
**Q: Claude 무료 계정도 사용할 수 있나요?**
A: 기술적으로는 로컬 MCP 방식으로 구현할 수 있지만, 보안상의 이유로 원격 MCP만 제공합니다. 따라서 원격 MCP를 지원하는 Claude Pro 이상의 유료 계정만 사용 가능합니다.
향후 Claude Desktop이 해당 기능을 지원한다면 사용할 수 있습니다.
...
- **GitHub 웹훅 처리**: 평균 2-5분 소요, 파일이 많을수록 오래 걸릴 가능성 있음
